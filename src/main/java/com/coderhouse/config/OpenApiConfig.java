	...
	OpenAPI customOpenAPI () {
		return new OpenAPI()
				.info(new Info()
						...
						.contact(new Contact()
								.name("Juan Pablo Dal Molin")
								.email("dalmolinjuanpablo@gmail.com")
								.url("https://github.com/jpdalmolin/java-entrega2"))
						.license(new License()
								.name("Licencia")
								.url("https://github.com/jpdalmolin/java-entrega2?tab=MIT-1-ov-file"))
						)
